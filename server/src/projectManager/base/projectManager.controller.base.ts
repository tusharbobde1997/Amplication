...
export class ProjectManagerControllerBase {
  ...
  async findManyPmEmployees(
    ...
    const results = await this.service.findPmEmployees(params.id, {
      where: query,
      select: {
        createdAt: true,
        empName: true,
  ...
  @common.Post("/:id/pmEmployees")
  @nestAccessControl.UseRoles({
    resource: "ProjectManager",
    action: "update",
    possession: "any",
  })
  async createPmEmployees(
    @common.Param() params: ProjectManagerWhereUniqueInput,
  ...
  @common.Patch("/:id/pmEmployees")
  @nestAccessControl.UseRoles({
    resource: "ProjectManager",
    action: "update",
    possession: "any",
  })
  async updatePmEmployees(
    @common.Param() params: ProjectManagerWhereUniqueInput,
    @common.Body() body: ProjectManagerWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
  ...
  @common.Delete("/:id/pmEmployees")
  @nestAccessControl.UseRoles({
    resource: "ProjectManager",
    action: "update",
    possession: "any",
  })
  async deletePmEmployees(
    @common.Param() params: ProjectManagerWhereUniqueInput,
    @common.Body() body: ProjectManagerWhereUniqueInput[],
    @nestAccessControl.UserRoles() userRoles: string[]
  ): Promise<void> {
